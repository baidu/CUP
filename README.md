...
**CUP is very steady on python 2.7.x. If you want to use CUP within python3, pls refer to version py 3.0 (alpha version, which is still under test/development)**
